...
// OcclusionManagement is a subclass of UIView and conforms to the informal protocol
// UIGLViewProtocol
@interface OcclusionManagementEAGLView : UIView <UIGLViewProtocol, SampleGLResourceHandler, SampleAppRendererControl> {
@private
    // OpenGL ES context
    EAGLContext *context;
